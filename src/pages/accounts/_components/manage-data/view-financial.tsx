...
import { FinancialStatementEntry } from "@/types/accounts.types";

interface ViewFinancialStatementEntryProps {
  entry: FinancialStatementEntry;
  onSave?: (updatedEntry: FinancialStatementEntry) => Promise<void>;
  onDelete?: () => Promise<void>;
}

export function ViewFinancialStatementEntry({
  entry: initialEntry,
  onSave,
  onDelete,
}: ViewFinancialStatementEntryProps) {
  ...
  const handleChange = (
    field: keyof FinancialStatementEntry,
        ...
        <SheetHeader className="p-6">
          ...
          <SheetDescription className="mt-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              {renderEditableDate("startDate", entry.startDate, "Start Date")}
              {renderEditableDate("endDate", entry.endDate, "End Date")}
              {renderEditableField(
                "totalRevenue",
                entry.totalRevenue,
                "Total Revenue",
