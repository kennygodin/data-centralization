...
import { InvoiceEntry } from "@/types/accounts.types";

interface ViewInvoiceEntryProps {
  entry: InvoiceEntry;
  onSave?: (updatedEntry: InvoiceEntry) => Promise<void>;
  onDelete?: () => Promise<void>;
}

export function ViewInvoiceEntry({
  entry: initialEntry,
  onSave,
  onDelete,
}: ViewInvoiceEntryProps) {
          ...
          <SheetDescription className="mt-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              {renderEditableSelect(
                ...
                "Status",
                ["Pending", "Paid", "Overdue", "Partially Paid", "Cancelled"]
              )}
              {renderEditableDate(
                "dateIssued",
                entry.dateIssued,
              ...
              {renderEditableSelect(
                ...
                entry.paymentTerms,
                "Payment Terms",
                ["Net 7", "Net 15", "Net 30", "Net 60", "Due on Receipt"]
              )}
