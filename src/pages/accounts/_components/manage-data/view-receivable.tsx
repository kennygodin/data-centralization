...
import { ReceivableEntry } from "@/types/accounts.types";

interface ViewReceivableEntryProps {
  entry: ReceivableEntry;
  onSave?: (updatedEntry: ReceivableEntry) => Promise<void>;
  onDelete?: () => Promise<void>;
}

export function ViewReceivableEntry({
  entry: initialEntry,
  onSave,
  onDelete,
}: ViewReceivableEntryProps) {
          ...
          <SheetDescription className="mt-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              {renderEditableSelect(
                ...
                entry.category,
                "Category",
                ["Services", "Products", "Subscriptions", "Rent", "Other"],
                true
              )}
              {renderEditableSelect(
                "status",
              ...
              <div className="flex gap-2 pt-2">
                {!isEditing && !isDeleting ? (
                  ...
                  <div className="w-full space-y-4 border border-destructive rounded-lg p-4">
                    ...
                    <p className="text-sm">
                      Are you sure you want to delete this receivable entry?
