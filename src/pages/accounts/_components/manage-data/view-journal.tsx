...
import { JournalEntry } from "@/types/accounts.types";
...
export function ViewJournalEntry({
  entry: initialEntry,
  onSave,
  onDelete,
        ...
        <SheetHeader className="p-6">
          ...
          <SheetDescription className="mt-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              {renderEditableField("amount", entry.amount || 0, "Amount", true)}
              {renderEditableSelect(
                "status",
              ...
              {renderEditableDate("date", entry.date, "Date")}
              {renderEditableField(
                "referenceNumber",
